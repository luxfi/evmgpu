...
var bindTests = []struct {
	...
	},
	{
		...
		`"github.com/stretchr/testify/require"
		 ...
		 "github.com/luxfi/evmgpu/core/extstate"
...
func TestPrecompileBind(t *testing.T) {
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-x", "-require", "github.com/luxfi/evmgpu@v0.0.0", "-replace", "github.com/luxfi/evmgpu="+filepath.Join(pwd, "..", "..", "..", "..")) // Repo root
	replacer.Dir = pkg
