...
func TestMain(m *testing.M) {
	opts := []goleak.Option{
		...
		goleak.IgnoreTopFunction("github.com/luxfi/evmgpu/core/state/snapshot.(*diskLayer).generate"),
		...
		goleak.IgnoreTopFunction("github.com/luxfi/evmgpu/metrics.(*meterArbiter).tick"),
