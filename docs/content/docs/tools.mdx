...
module.exports = {
  ...
  networks: {
    luxevm: {
      url: "http://localhost:9650/v1/chain/c",
      chainId: 43112,
      accounts: [process.env.PRIVATE_KEY],
      gasPrice: 25000000000,
    },
    luxMainnet: {
      url: "https://api.lux.network/v1/chain/c",
      chainId: 96369,
      accounts: [process.env.PRIVATE_KEY],
    },
    luxTestnet: {
      url: "https://api.lux-test.network/v1/chain/c",
      chainId: 96370,
      accounts: [process.env.PRIVATE_KEY],
    },
  },
...
npx hardhat node --fork http://localhost:9650/v1/chain/c
```
...
[rpc_endpoints]
luxevm = "http://localhost:9650/v1/chain/c"
luxMainnet = "https://api.lux.network/v1/chain/c"
luxTestnet = "https://api.lux-test.network/v1/chain/c"
...
| RPC URL | https://api.lux.network/v1/chain/c | https://api.lux-test.network/v1/chain/c | http://localhost:9650/v1/chain/c |
    ...
    params: [
      {
        ...
        rpcUrls: ["https://api.lux.network/v1/chain/c"],
...
const luxMainnet = {
  ...
  rpcUrls: {
    default: {
      http: ["https://api.lux.network/v1/chain/c"],
    },
  },
  blockExplorers: {
...
const provider = new ethers.JsonRpcProvider(
  "http://localhost:9650/v1/chain/c"
);
...
const luxMainnet = {
  ...
  rpcUrls: {
    default: { http: ["https://api.lux.network/v1/chain/c"] },
  },
  blockExplorers: {
    default: { name: "Explorer", url: "https://explorer.lux.network" },
  },
...
// Connect to Lux EVM
const web3 = new Web3("http://localhost:9650/v1/chain/c");
...
anvil --fork-url http://localhost:9650/v1/chain/c --chain-id 43112

# With specific block
anvil --fork-url http://localhost:9650/v1/chain/c --fork-block-number 1000000
```
