...
Once you have Luxd running locally, it will be running an HTTP Server on the default port `9650`. This means that the RPC Endpoint for the C-Chain will be http://127.0.0.1:9650/v1/chain/c and ws://127.0.0.1:9650/v1/chain/c/ws for WebSocket connections.
